...
if __name__ == "__main__":
    ...
    GPIO.add_event_detect(config['sos_button_pin'], GPIO.FALLING, callback=sos_sequence, bouncetime=3000)
    print("SOS device armed. Waiting for button press...")
